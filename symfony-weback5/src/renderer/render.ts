...
import { twig, TwigTemplate } from "./twig";
...
const fetchStoryHtml: FetchStoryHtmlType = async (
  url,
  path,
  params,
  storyContext,
...
export async function renderToCanvas(
  ...
  // missing type inference from storybook
  const {
 ...
 */
const showSymfonyError = (
  storyId: StoryId,
  canvasElement: HTMLElement,
  error: SymfonyRenderingError
) => {
 ...
 */
const configureLiveComponentErrorCatcher = (
  storyId: StoryId,
  canvasElement: HTMLElement
) => {
